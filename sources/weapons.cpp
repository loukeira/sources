...
int32_t WeaponMelee::getWeaponDamage(const Player* player, const Creature* target, const Item* item, bool maxDamage /*= false*/) const
{
   ...
   int32_t getAttackRight;
   int32_t getLeftExtraAttack;
int32_t getRightExtraAttack;

   getAttackLeft = 0;
   getAttackRight = 0;
   getLeftExtraAttack = 0;
getRightExtraAttack = 0;
   ...
   { 
       ...
       {
       getAttackRight = player->getInventoryItem(SLOT_RIGHT)->getAttack();
       getRightExtraAttack = player->getInventoryItem(SLOT_RIGHT)->getExtraAttack();
       }
   ...
   int32_t attackValue = std::max((int32_t)0, (int32_t)((getAttackLeft + getLeftExtraAttack + getAttackRight + getRightExtraAttack) ));                                               
