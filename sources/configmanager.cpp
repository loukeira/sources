...
bool ConfigManager::load()
{
	...
	//adicionado
	m_confNumber[HEALTH_HEALING_COLOR] = getGlobalNumber("healthHealingColor", COLOR_LIGHTGREEN);
	m_confNumber[MANA_HEALING_COLOR] = getGlobalNumber("manaHealingColor", COLOR_185);
